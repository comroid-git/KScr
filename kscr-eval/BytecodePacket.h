...
public:
	...
	static constexpr int EXPRESSION_NUMERIC     = 0x0010;
	static constexpr int EXPRESSION_STRING      = 0x0020;
	static constexpr int EXPRESSION_TRUE        = 0x0040;
	static constexpr int EXPRESSION_FALSE       = 0x0080;
	static constexpr int EXPRESSION_reserved    = 0x00F0;
