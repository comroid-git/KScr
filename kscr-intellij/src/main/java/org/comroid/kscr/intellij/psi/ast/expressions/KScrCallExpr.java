...
import org.comroid.kscr.intellij.psi.ast.common.KScrCall;
...
public class KScrCallExpr extends KScrExpression{
	...
	public boolean isSuperCall(){
		return !PsiUtils.matchingChildren(this, k -> k.getNode().getElementType() == Tokens.getFor(KScrlicLangParser.SUPER)).isEmpty();
	}
